...
Object.defineProperty(exports,"__esModule",{value:!0}),__webpack_require__(9526),__webpack_require__(8665),__webpack_require__(3660),__webpack_require__(7621),__webpack_require__(3361),__webpack_require__(9449),__webpack_require__(5441),__webpack_require__(7318),__webpack_require__(5487),__webpack_require__(8851),__webpack_require__(492),__webpack_require__(9648),__webpack_require__(5283),__webpack_require__(1675),__webpack_require__(2158),__webpack_require__(9931),__webpack_require__(9139),__webpack_require__(3876),__webpack_require__(3624),__webpack_require__(4158),__webpack_require__(191),__webpack_require__(2441),__webpack_require__(6527),__webpack_require__(7228)
...
let bitrate1=parseInt(result)
isNaN(bitrate1)||bitrate1<96||bitrate1>999?bitrate1=192e3:bitrate1*=1e3,song.br=bitrate1}isHost("googlevideo.com")&&(song.br=128e3)}if(headers&&(isHost("126.net")&&(song.md5=song.url.split("/").slice(-1)[0].replace(/\..*/g,"")),isHost("kuwo.cn")&&song.br<=32e4&&(song.md5=headers.etag.replace(/"/g,"")),isHost("qq.com")&&(song.md5=headers["server-md5"]),song.size=parseInt((headers["content-range"]||"").split("/").pop()||headers["content-length"])||0,!isHost("yt-download.org")&&"8192"!==headers["content-length"]))return Promise.reject()
...
audioDataArr=audioDataArr.map((result=>result.value)),audioData=audioDataArr.reduce(((a,b)=>a.br>=b.br?a:b))}else if(process.env.FOLLOW_SOURCE_ORDER){for(let i=0;i<candidate.length;i++){const source1=candidate[i]
...
return result.error&&reject(result.value),capability.promise}})},191:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
